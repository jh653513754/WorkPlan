...
@interface YAHTrendsViewController ()

@end

@implementation YAHTrendsViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    
//    self.navigationItem.leftBarButtonItem = [[UIBarButtonItem alloc]initWithTitle:@"最新动态" style:UIBarButtonItemStylePlain target:self action:@selector(Click)];
